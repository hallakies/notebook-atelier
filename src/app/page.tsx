...
const decisionPoints = [
  {
    label: "Air vs Pro",
    title: "가벼움이 중요한지, 성능 여유가 중요한지부터 나눕니다",
    body:
      "무조건 비싼 모델이 정답은 아닙니다. 이동이 많은지, 오래 켜두는지, 무거운 작업을 하는지에 따라 답이 달라집니다.",
  },
  {
    label: "Use Case",
    title: "학생, 직장인, 개발자, 크리에이터의 기준은 다릅니다",
    body:
      "과제와 문서 작업, 멀티태스킹, 영상 편집은 필요한 성능과 화면 크기가 서로 다릅니다. 같은 맥북 추천이 모두에게 맞을 수는 없습니다.",
  },
  {
    label: "Buying Timing",
    title: "지금 사도 되는지, 한 단계 더 기다릴지도 같이 판단합니다",
    body:
      "스펙만 비교하지 않고 현재 판매 중인 라인업 기준으로 어떤 모델이 가장 합리적인지 빠르게 좁혀드립니다.",
  },
];
...
const trustSignals = [
  {
    title: "4개의 질문",
    copy: "복잡한 스펙표 대신 핵심 질문만으로 결정 피로를 줄입니다.",
  },
  {
    title: "현재 라인업 기준",
    copy: "지금 구매 가능한 맥북 기준으로 추천 결과를 보여줍니다.",
  },
  {
    title: "실사용 중심",
    copy: "무게, 배터리, 작업 흐름처럼 실제 체감 포인트를 중심에 둡니다.",
  },
];
...
const guides = [
  {
    category: "학생용 기준",
    title: "가볍고 오래가는 쪽이 중요한 사람",
    excerpt:
      "매일 들고 다니고 문서, 브라우징, 수업, 가벼운 편집이 중심이라면 어디까지면 충분한지 정리합니다.",
  },
  {
    category: "개발용 기준",
    title: "여러 앱과 브라우저 탭을 동시에 쓰는 사람",
    excerpt:
      "코드 편집, 외부 모니터, 메모리 여유가 중요할 때 Air와 Pro 사이 기준선을 어떻게 잡아야 하는지 다룹니다.",
  },
  {
    category: "크리에이터용 기준",
    title: "화면과 성능 여유가 수익과 연결되는 사람",
    excerpt:
      "영상 편집과 디자인 작업에서 화면 크기와 칩 선택이 왜 직접적인 생산성 차이로 이어지는지 설명합니다.",
  },
];
...
const timeline = [
  {
    year: "2008",
    title: "Air는 휴대성을 고르는 기준이 됐습니다",
    body: "얇고 가벼운 노트북을 원하는 사람에게 무엇이 중요한지 시장 전체의 언어를 바꿨습니다.",
  },
  {
    year: "2015",
    title: "디스플레이와 입력 경험이 더 중요해졌습니다",
    body: "트랙패드와 화면 품질은 숫자보다 오래 체감되는 요소라는 기준이 자리 잡았습니다.",
  },
  {
    year: "2020",
    title: "Apple silicon 이후 선택 기준이 다시 정리됐습니다",
    body: "배터리와 성능 효율이 함께 좋아지면서 어떤 사용자가 어떤 모델을 고르면 되는지 더 명확해졌습니다.",
  },
  {
    year: "2026",
    title: "지금은 Air와 Pro의 역할이 훨씬 뚜렷합니다",
    body: "가벼운 일상용과 본격 작업용의 차이가 선명해져 추천 로직을 더 분명하게 설명할 수 있습니다.",
  },
];
...
const reviewRooms = [
  {
    label: "실사용 리뷰",
    title: "긴 리뷰를 다 볼 필요는 없습니다",
    body:
      "여러 유튜브 리뷰를 한 번 더 걸러서 실제 구매 판단에 도움이 되는 포인트만 남깁니다.",
  },
  {
    label: "신제품 브리핑",
    title: "지금 사도 되는지 빠르게 확인합니다",
    body:
      "신제품 발표, 라인업 변화, 구매 타이밍 이슈를 짧고 분명하게 정리합니다.",
  },
  {
    label: "구매 가이드",
    title: "결정 전에 필요한 글만 남깁니다",
    body:
      "맥북 역사와 모델별 차이, 실사용 기준을 차분하게 정리해 추천 결과를 더 납득할 수 있게 돕습니다.",
  },
];

const socialPillars = [
  "한 장씩 넘기며 이해할 수 있는 짧은 카드 브리핑",
  "신제품과 구매 타이밍을 빠르게 읽는 요약 포맷",
  "기사 내용을 저장하기 쉬운 캐러셀로 다시 정리한 콘텐츠",
];
          ...
          <div className="grid gap-10 lg:grid-cols-[0.84fr_1.16fr]">
            <div className="space-y-6">
              ...
              <p className="section-copy">
                학생용, 개발용, 크리에이터용 기준은 서로 다릅니다. 그래서
                추천 결과가 끝이 아니라, 왜 그 모델이 맞는지 이해할 수 있는
                설명도 함께 쌓아갑니다.
              </p>
        ...
        <div className="mx-auto max-w-7xl rounded-[34px] border border-black/6 bg-[rgba(255,255,255,0.56)] px-5 py-10 shadow-[0_28px_80px_rgba(35,38,43,0.08)] backdrop-blur-xl sm:px-8 lg:px-10">
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            <div>
              ...
              <h2 className="section-title">
                맥북의 흐름을 알면 지금 어떤 모델을 사야 할지도 쉬워집니다
              </h2>
              <p className="section-copy">
                이 섹션은 단순한 역사 소개가 아니라, 왜 Air와 Pro가 지금처럼
                나뉘어 보이는지 이해하도록 돕는 배경 설명입니다.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-7xl rounded-[34px] border border-[rgba(25,27,31,0.08)] bg-[linear-gradient(145deg,rgba(255,255,255,0.75),rgba(239,233,224,0.84))] px-5 py-10 shadow-[0_32px_90px_rgba(28,31,38,0.1)] sm:px-8 lg:px-10">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
            <div>
              ...
              <h2 className="section-title">
                긴 글로 읽고, 짧은 카드로 다시 확인할 수 있게 만듭니다
              </h2>
              <p className="section-copy">
                모델 비교와 신제품 변화가 한눈에 들어오도록 짧은 카드
                브리핑과 요약 콘텐츠도 함께 운영합니다. 검색에서 들어온
                정보가 다시 기억에 남도록 만드는 장치입니다.
              </p>
            </div>
            ...
            <div className="grid gap-3">
              ...
              <div className="surface-panel mt-2">
                ...
                <p className="mt-4 text-sm leading-7 text-[var(--muted)]">
                  지금 사도 되는지, 어떤 차이가 체감되는지, 내 작업에 뭐가
                  맞는지를 짧고 정확하게 다시 확인할 수 있는 요약 콘텐츠를
                  제공합니다.
                </p>
              </div>
            </div>
