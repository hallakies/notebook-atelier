...
export const buyingGuides: BuyingGuide[] = [
  ...
  {
    slug: "best-macbook-for-external-monitors",
    category: "외부 모니터용 맥북",
    title: "외부 모니터 많이 쓰면 어떤 맥북이 맞을까",
    excerpt:
      "책상에 앉아 외부 모니터를 자주 연결한다면, 휴대성보다 포트 구성과 지속 성능이 더 크게 체감됩니다.",
    seoTitle: "외부 모니터용 맥북 추천 | 듀얼 모니터 기준 MacBook 고르기",
    seoDescription:
      "외부 모니터, 데스크 셋업, 장시간 멀티태스킹 기준으로 어떤 맥북이 더 잘 맞는지 정리한 구매 가이드.",
    publishedAt: "2026-03-29",
    heroIntro:
      "맥북을 닫아두고 외부 모니터 중심으로 쓰는 사람이라면, 얇고 가벼운 것보다 포트 구성과 안정적인 지속 성능이 먼저 체감됩니다.",
    finderPrompt:
      "책상 중심 사용과 외부 모니터 비중을 기준으로 어떤 맥북이 맞는지 바로 확인해보세요.",
    recommendedModelIds: ["air-15-m5", "pro-14-m5", "pro-14-m5-pro"],
    sections: [
      {
        title: "외부 모니터 중심 사용에서 중요한 것",
        paragraphs: [
          "집이나 사무실 책상에서 큰 화면에 연결해 두고 쓰는 시간이 길다면, 화면 크기보다 연결 편의성과 멀티태스킹 안정감이 더 중요해집니다.",
          "특히 브라우저, 문서, 슬랙, 화상회의, 여러 업무 앱을 함께 띄우는 흐름이라면 Air와 Pro의 차이가 생각보다 빨리 드러납니다.",
        ],
      },
      {
        title: "Air와 Pro를 나누는 기준",
        paragraphs: [
          "외부 모니터를 하나 연결하고 가벼운 사무 작업 위주로 쓴다면 Air 15도 충분히 만족도가 높습니다.",
          "하지만 모니터 연결이 길고, 업무 앱이 많고, 장시간 버벅임 없는 리듬이 중요하다면 Pro 14 계열이 더 안정적입니다.",
        ],
      },
    ],
  },
  {
    slug: "best-macbook-for-graduate-students",
    category: "대학원생 맥북",
    title: "대학원생에게 맞는 맥북은 무엇일까",
    excerpt:
      "리서치, 논문 작성, PDF 정리, 발표 자료, 긴 배터리 시간을 함께 보려면 대학원생용 맥북 기준이 조금 더 선명해집니다.",
    seoTitle: "대학원생 맥북 추천 | 연구와 논문 작업용 MacBook 고르기",
    seoDescription:
      "논문, PDF 리서치, 발표 준비, 이동 많은 연구 생활을 기준으로 대학원생에게 맞는 맥북을 정리한 가이드.",
    publishedAt: "2026-03-29",
    heroIntro:
      "대학원생에게 필요한 맥북은 최고 성능보다 긴 글쓰기 시간과 많은 PDF를 동시에 다뤄도 지치지 않는 안정감에 가깝습니다.",
    finderPrompt:
      "논문 작성과 리서치 중심 사용 기준으로 어떤 맥북이 맞는지 바로 진단해보세요.",
    recommendedModelIds: ["air-13-m5", "air-15-m5", "pro-14-m5"],
    sections: [
      {
        title: "대학원생에게 중요한 체감 요소",
        paragraphs: [
          "논문 작성, 자료 검색, PDF 주석, 발표 자료 정리는 순간 최고 성능보다 오랫동안 편하게 쓰는 감각이 더 중요합니다.",
          "여기에 세미나, 도서관, 카페 이동이 잦다면 무게와 배터리가 실제 만족도를 좌우합니다.",
        ],
      },
      {
        title: "언제 Air로 충분하고 언제 Pro가 필요한가",
        paragraphs: [
          "문서와 리서치 중심이라면 Air 13이 가장 무난하고, 화면 여유가 중요하면 Air 15가 더 편합니다.",
          "데이터 분석, 개발, 영상 편집, 다수의 전문 앱이 함께 돌아간다면 Pro 14로 보는 편이 안전합니다.",
        ],
      },
    ],
  },
  {
    slug: "should-i-buy-my-own-macbook-for-work",
    category: "회사원 구매 판단",
    title: "회사 지급 노트북 대신 맥북을 사도 될까",
    excerpt:
      "업무용으로 개인 맥북을 따로 살지 고민된다면, 휴대성과 만족감보다 먼저 봐야 할 기준이 있습니다.",
    seoTitle: "회사 노트북 대신 맥북 사도 될까 | 직장인 구매 판단 가이드",
    seoDescription:
      "회사 지급 노트북 대신 개인 맥북을 따로 살지 고민하는 직장인을 위한 구매 판단 가이드.",
    publishedAt: "2026-03-29",
    heroIntro:
      "회사 지급 장비가 있는데도 맥북을 별도로 사고 싶다면, 감성보다 먼저 업무 호환성과 실제 사용 시간을 따져봐야 합니다.",
    finderPrompt:
      "업무용 개인 구매가 맞는지, 맞다면 어떤 맥북이 적당한지 바로 확인해보세요.",
    recommendedModelIds: ["air-13-m5", "air-15-m5", "pro-14-m5"],
    sections: [
      {
        title: "먼저 확인할 현실적인 기준",
        paragraphs: [
          "회사 VPN, 보안 프로그램, 사내 메신저, 필수 업무 툴이 맥에서 문제없이 돌아가는지부터 확인해야 합니다.",
          "이 조건이 맞지 않으면 비싼 맥북을 사더라도 실제 업무 장비로 정착하지 못할 가능성이 큽니다.",
        ],
      },
      {
        title: "그래도 개인 맥북이 좋은 경우",
        paragraphs: [
          "이동이 많고 문서, 회의, 메일, 브라우저, 슬라이드 작업 비중이 높다면 개인 맥북이 만족도를 크게 올릴 수 있습니다.",
          "반대로 무거운 회사 시스템과 윈도우 전용 툴 의존도가 크다면 Pro보다도 구매 자체를 다시 생각해 보는 편이 낫습니다.",
        ],
      },
    ],
  },
  {
    slug: "best-macbook-for-coding-study",
    category: "코딩 공부용 맥북",
    title: "코딩 공부용 맥북은 어디까지 보면 될까",
    excerpt:
      "개발 입문과 코딩 공부라면, 현업용 최고 사양보다 오래 쓰기 편한 기본기와 여유 메모리가 더 중요합니다.",
    seoTitle: "코딩 공부용 맥북 추천 | 개발 입문용 MacBook 고르기",
    seoDescription:
      "개발 입문, 코딩 공부, 가벼운 프로젝트 기준으로 어떤 맥북이 적당한지 정리한 구매 가이드.",
    publishedAt: "2026-03-29",
    heroIntro:
      "코딩 공부용 맥북은 처음부터 최고 사양으로 가는 것보다, 오래 켜 두고 여러 창을 띄워도 답답하지 않은 구성이 더 중요합니다.",
    finderPrompt:
      "개발 입문과 코딩 공부 기준으로 어떤 맥북이 맞는지 바로 확인해보세요.",
    recommendedModelIds: ["air-13-m5", "air-15-m5", "pro-14-m5"],
    sections: [
      {
        title: "코딩 공부용으로 먼저 볼 기준",
        paragraphs: [
          "강의 영상, 브라우저 탭, 에디터, 터미널, 메신저를 함께 켜는 흐름이 기본이라 메모리 여유와 발열 안정감이 중요합니다.",
          "처음부터 무거운 현업용 프로젝트가 아니라면 Air 계열로도 충분히 쾌적하게 시작할 수 있습니다.",
        ],
      },
      {
        title: "언제 Pro까지 봐야 하나",
        paragraphs: [
          "앱 개발, 여러 도구 동시 실행, 로컬 데이터베이스, Docker처럼 부담이 커지기 시작하면 Pro 14가 더 마음이 편합니다.",
          "하지만 입문 단계에서 가장 중요한 건 과한 사양이 아니라 꾸준히 켜 두고 공부하기 좋은 밸런스입니다.",
        ],
      },
    ],
  },
